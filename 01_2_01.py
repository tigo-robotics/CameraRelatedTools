...
def main():
    ...
    # Here you can add code to use the calibration data for further processing
    # For example, undistorting images, computing disparity, etc.
    ...
    while True:
        ...
        left_undistorted = cv2.undistort(left_frame, mtx_left, dist_left)
        right_undistorted = cv2.undistort(right_frame, mtx_right, dist_right)
